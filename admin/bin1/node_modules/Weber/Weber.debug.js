...
define('JsList', function (require, module, exports) {
    ...
    function JsList(dir, config) {
        ...
        var meta = {
            ...
            'file$stat': {},    //记录该 md5 所对应的文件内容中的最大行数和最大列数信息。 
    ...
    JsList.prototype = {
        ...
        */
        get: function () {
            ...
            meta.list = $.Array.keep(list, function (file, index) {
    ...
    JsScripts.prototype = {
        ...
        */
        unique: function () {
            ...
            $.Object.each(file$md5, function (file, md5) {
            ...
            $.Object.each(md5$files, function (md5, files) {
                ...
                if (files.length > 1) {
                    console.log('内容完全相同的文件: '.bgRed.yellow, meta.dir);
                    console.log('    ' + files.join('\r\n    ').yellow);
                }

                files.forEach(function (file) {

                    var htmls = $.Array.map(list, function (item) {
                        return item.file == file ? item.html : null;
                    });

                    if (htmls.length > 1) {
                        console.log('重复引用同一个文件: '.bgRed.yellow, meta.dir);
