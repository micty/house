...
*    defaults/third-party/CloudHome.API.js
*    defaults/third-party/ImageReader.js
*    defaults/third-party/WeChat.js
*    defaults/third-party/WeChat/Signature.js
...
*    defaults/ui/NumberPad.js
*    defaults/ui/Panel.js
*    defaults/ui/Scroller.js
*    defaults/ui/Tabs.js
...
* @name Slider
*/
define('Slider', function (require, module, exports) {

    //http://be-fe.github.io/iSlider/demo/index_chinese.html
...
/**
* CityPicker 模块的默认配置
* @name CityPicker.defaults
*/
define('CityPicker.defaults', /**@lends CityPicker.defaults*/ {
    ...
    mask: 0.2,
    title: '选择地址',
    sample: '<iframe id="{id}" src="{dir}iframe/CityPicker.html?id={id}&title={title}"></iframe>',
...
/**
* ImageSlider 模块的默认配置
* @name ImageSlider.defaults
*/
define('ImageSlider.defaults', /**@lends ImageSlider.defaults*/ {

    /**
    * 生成的 id 的前缀。
    */
    prefix: 'KISP-ImageSlider-',
    ...
    */
    ...
    sample: '<img style="max-width: 100%; max-height: 100%;" src="{src}" />',
